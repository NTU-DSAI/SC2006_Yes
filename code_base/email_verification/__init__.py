...
Usage:
from email_verification.otp import TimedRandomDigitOTP, RandomDigitOTP
...
OTP_METHOD = TimedRandomDigitOTP # RandomDigitOTP works as well
...
# run
mailer.send(recipient = recipient, subject = subject, contents = contents.format(otp_gen.otp))
value = input("Enter your OTP: ")
print("Pass" if otp_gen.verify(value) else 'Fail')
'''
